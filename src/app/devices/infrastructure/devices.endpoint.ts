...
export const DEVICE_BY_ID_URL = (deviceId: string) => `${DEVICES_BASE}/${deviceId}`;
export const CREATE_DEVICE_URL = () => DEVICES_BASE;
...
export const UPDATE_DEVICE_STATUS_URL = (deviceId: string) => `${DEVICES_BASE}/${deviceId}/status`;
export const UPDATE_DISPLAY_MODE_URL = (deviceId: string) =>
  `${DEVICES_BASE}/${deviceId}/display-mode`;
...
export const DEVICES_HEALTH_URL = (deviceId?: string) =>
  deviceId
    ? `${environment.baseUrl}/devices-health?deviceId=${deviceId}`
    : `${environment.baseUrl}/devices-health`;

export const THRESHOLDS_BY_ACCOUNT_URL = (accountId: string) =>
  `${THRESHOLDS_BASE}?accountId=${accountId}`;
export const CREATE_THRESHOLD_URL = () => THRESHOLDS_BASE;
export const THRESHOLD_BY_ID_URL = (thresholdId: string) => `${THRESHOLDS_BASE}/${thresholdId}`;
